...
rules = [
    ...
    policy.RuleDefault(SERVERS % 'confirm_live_resize', RULE_AOO),
    ...
    policy.RuleDefault(SERVERS % 'live_resize_flavor_check', RULE_AOO),
    policy.RuleDefault(SERVERS % 'live_resize_switch', RULE_AOO),
